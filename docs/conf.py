# -*- coding: utf-8 -*-
#
# omdk documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'omdk.tex', u'omdk Documentation',
     u'Sandeep Murthy', 'manual'),
]
...
man_pages = [
    (master_doc, 'omdk', u'omdk Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'omdk', u'omdk Documentation',
     author, 'omdk', 'One line description of project.',
     'Miscellaneous'),
]
