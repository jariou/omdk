...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:agt="http://www.altova.com/Mapforce/agt" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="vmf agt xs">
	...
	<xsl:template name="agt:MapToModelLocARA_var44_function">
		<xsl:param name="var43_current"/>
		<xsl:variable name="var41_resultof_cast" select="string('1')"/>
		<xsl:variable name="var42_resultof_cast" select="string('0')"/>
		<xsl:variable name="var31_ROWID">
			<xsl:if test="$var43_current/@ROW_ID">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var32_resultof_exists" select="boolean(string($var31_ROWID))"/>
		<xsl:variable name="var33_OCCSCHEME">
			<xsl:if test="$var43_current/@OCCSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var34_resultof_exists" select="boolean(string($var33_OCCSCHEME))"/>
		<xsl:variable name="var35_ROOFSYS">
			<xsl:if test="$var43_current/@ROOFSYS">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var36_resultof_exists" select="boolean(string($var35_ROOFSYS))"/>
		<xsl:variable name="var37_ROOFGEOM">
			<xsl:if test="$var43_current/@ROOFGEOM">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var38_resultof_exists" select="boolean(string($var37_ROOFGEOM))"/>
		<xsl:variable name="var39_BLDGSCHEME">
			<xsl:if test="$var43_current/@BLDGSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var40_resultof_exists" select="boolean(string($var39_BLDGSCHEME))"/>
		<rec>
			<xsl:attribute name="RecTypeCode60">
				<xsl:value-of select="string('60')"/>
			</xsl:attribute>
			<xsl:attribute name="PolID60">
				<xsl:value-of select="$var41_resultof_cast"/>
			</xsl:attribute>
			...
			<xsl:if test="string($var32_resultof_exists) != 'false'">
				<xsl:attribute name="LocID63">
					<xsl:value-of select="string($var43_current/@ROW_ID)"/>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var1_STATECODE">
				<xsl:if test="$var43_current/@STATECODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
					...
					<xsl:with-param name="input">
						<xsl:choose>
							<xsl:when test="string(boolean(string($var1_STATECODE))) != 'false'">
								<xsl:value-of select="string($var43_current/@STATECODE)"/>
							</xsl:when>
							<xsl:otherwise>
			...
			<xsl:variable name="var2_COUNTYCODE">
				<xsl:if test="$var43_current/@COUNTYCODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="SubArea">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var2_COUNTYCODE))) != 'false'">
						<xsl:value-of select="string($var43_current/@COUNTYCODE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var3_POSTALCODE">
				<xsl:if test="$var43_current/@POSTALCODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="PostalArea">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var3_POSTALCODE))) != 'false'">
						<xsl:value-of select="string($var43_current/@POSTALCODE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="'X'"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var4_LATITUDE">
				<xsl:if test="$var43_current/@LATITUDE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="GeoLat">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var4_LATITUDE))) != 'false'">
						<xsl:value-of select="string($var43_current/@LATITUDE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var5_LONGITUDE">
				<xsl:if test="$var43_current/@LONGITUDE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="GeoLong">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var5_LONGITUDE))) != 'false'">
						<xsl:value-of select="string($var43_current/@LONGITUDE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var6_NUMBLDGS">
				<xsl:if test="$var43_current/@NUMBLDGS">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var6_NUMBLDGS))) != 'false'">
				<xsl:attribute name="RiskCount">
					<xsl:value-of select="string($var43_current/@NUMBLDGS)"/>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var7_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf2_inputtoresult">
					<xsl:with-param name="input" select="string($var43_current/@BLDGSCHEME)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string($var40_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var7_resultof_vmf__inputtoresult))) != 'false'">
					<xsl:attribute name="ConType">
						<xsl:value-of select="substring($var7_resultof_vmf__inputtoresult, 2)"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var8_BLDGCLASS">
				<xsl:if test="$var43_current/@BLDGCLASS">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string($var40_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var8_BLDGCLASS))) != 'false'">
					<xsl:attribute name="ConBldg">
						<xsl:call-template name="vmf:vmf3_inputtoresult">
							<xsl:with-param name="input" select="concat(string($var43_current/@BLDGSCHEME), string($var43_current/@BLDGCLASS))"/>
						</xsl:call-template>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			...
			<xsl:variable name="var10_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf4_inputtoresult">
					<xsl:with-param name="input" select="string($var43_current/@OCCSCHEME)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string($var34_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var10_resultof_vmf__inputtoresult))) != 'false'">
					<xsl:attribute name="OccType">
						<xsl:value-of select="substring($var10_resultof_vmf__inputtoresult, 2)"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var11_OCCTYPE">
				<xsl:if test="$var43_current/@OCCTYPE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string($var34_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var11_OCCTYPE))) != 'false'">
					<xsl:attribute name="Occ">
						<xsl:call-template name="vmf:vmf5_inputtoresult">
							<xsl:with-param name="input" select="concat(string($var43_current/@OCCSCHEME), string($var43_current/@OCCTYPE))"/>
						</xsl:call-template>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var12_YEARUPGRAD">
				<xsl:if test="$var43_current/@YEARUPGRAD">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var13_YEARBUILT">
				<xsl:if test="$var43_current/@YEARBUILT">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var20_resultof_cast" select="string('9999')"/>
			<xsl:variable name="var18_resultof_substring" select="substring(string($var43_current/@YEARBUILT), '7', '4')"/>
			<xsl:variable name="var19_resultof_substring" select="substring(string($var43_current/@YEARUPGRAD), '7', '4')"/>
			<xsl:variable name="var16_resultof_contains" select="contains($var18_resultof_substring, $var20_resultof_cast)"/>
			<xsl:variable name="var17_resultof_contains" select="contains($var19_resultof_substring, $var20_resultof_cast)"/>
			<xsl:variable name="var14_result">
				<xsl:choose>
					<xsl:when test="string($var17_resultof_contains) != 'false'">
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var19_resultof_substring"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="var15_result">
				<xsl:choose>
					<xsl:when test="string($var16_resultof_contains) != 'false'">
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var18_resultof_substring"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var12_YEARUPGRAD))) != 'false'">
				<xsl:if test="string(boolean(string($var13_YEARBUILT))) != 'false'">
					<xsl:attribute name="YearBuilt">
						<xsl:choose>
							<xsl:when test="string(($var14_result &gt;= $var15_result)) != 'false'">
								<xsl:choose>
									<xsl:when test="string($var17_resultof_contains) != 'false'">
										<xsl:value-of select="$var42_resultof_cast"/>
									</xsl:when>
			...
			<xsl:variable name="var21_NUMSTORIES">
				<xsl:if test="$var43_current/@NUMSTORIES">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="Stories">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var21_NUMSTORIES))) != 'false'">
						<xsl:value-of select="string($var43_current/@NUMSTORIES)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var42_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var22_FLOORAREA">
				<xsl:if test="$var43_current/@FLOORAREA">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var22_FLOORAREA))) != 'false'">
				<xsl:attribute name="GrossArea">
					<xsl:value-of select="string($var43_current/@FLOORAREA)"/>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:if test="string($var38_resultof_exists) != 'false'">
				<xsl:attribute name="IrRoofGeometry">
					<xsl:call-template name="vmf:vmf6_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@ROOFGEOM)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:if test="string($var38_resultof_exists) != 'false'">
			...
			<xsl:if test="string($var36_resultof_exists) != 'false'">
				<xsl:attribute name="IrRoofCover">
					<xsl:call-template name="vmf:vmf8_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@ROOFSYS)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var23_ROOFFRAME">
				<xsl:if test="$var43_current/@ROOFFRAME">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var23_ROOFFRAME))) != 'false'">
				<xsl:attribute name="IrRoofDeck">
					<xsl:call-template name="vmf:vmf9_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@ROOFFRAME)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var24_CLADRATE">
				<xsl:if test="$var43_current/@CLADRATE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var24_CLADRATE))) != 'false'">
				<xsl:attribute name="IrRoofDeckAttch">
					<xsl:call-template name="vmf:vmf10_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@CLADRATE)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var25_ROOFANCH">
				<xsl:if test="$var43_current/@ROOFANCH">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var25_ROOFANCH))) != 'false'">
				<xsl:attribute name="IrRoofAnchorage">
					<xsl:call-template name="vmf:vmf11_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@ROOFANCH)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var26_ROOFAGE">
				<xsl:if test="$var43_current/@ROOFAGE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var26_ROOFAGE))) != 'false'">
				<xsl:attribute name="IrRoofBuilt">
					<xsl:call-template name="vmf:vmf12_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@ROOFAGE)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var27_RESISTOPEN">
				<xsl:if test="$var43_current/@RESISTOPEN">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var27_RESISTOPEN))) != 'false'">
				<xsl:attribute name="IrWindowProt">
					<xsl:call-template name="vmf:vmf13_inputtoresult">
						<xsl:with-param name="input" select="string($var43_current/@RESISTOPEN)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var30_resultof_cast" select="string('12')"/>
			<xsl:variable name="var28_resultof_vmf___inputtoresult">
				<xsl:call-template name="vmf:vmf14_inputtoresult">
					<xsl:with-param name="input" select="string($var43_current/@ROOFSYS)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:variable name="var29_resultof_equal" select="($var28_resultof_vmf___inputtoresult = $var30_resultof_cast)"/>
			<xsl:if test="string($var36_resultof_exists) != 'false'">
				<xsl:if test="string(($var29_resultof_equal or $var38_resultof_exists)) != 'false'">
					<xsl:attribute name="IrMechSystem">
						<xsl:choose>
							<xsl:when test="string($var29_resultof_equal) != 'false'">
	...
	<xsl:template name="agt:MapToModelLocARA_var46_resultof_map">
		<xsl:param name="var45_current"/>
		<xsl:for-each select="$var45_current/rec">
			<xsl:call-template name="agt:MapToModelLocARA_var44_function">
	...
	<xsl:template match="/">
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">C:/Users/Administrator/Desktop/git/ARA_Joh/flamingo/hurloss/Files/ValidationFiles/ModelLocARA.xsd</xsl:attribute>
			<xsl:for-each select="root">
				<xsl:call-template name="agt:MapToModelLocARA_var46_resultof_map">
