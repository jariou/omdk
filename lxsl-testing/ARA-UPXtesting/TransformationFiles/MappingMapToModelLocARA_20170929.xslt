...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:agt="http://www.altova.com/Mapforce/agt" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="vmf agt xs">
	...
	<xsl:template name="agt:MapToModelLocARA_var49_function">
		...
		<xsl:variable name="var46_resultof_cast" select="string('0')"/>
		<xsl:variable name="var47_resultof_cast" select="string('1')"/>
		<xsl:variable name="var34_BLDGSCHEME">
			<xsl:if test="$var48_current/@BLDGSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var35_resultof_exists" select="boolean(string($var34_BLDGSCHEME))"/>
		<xsl:variable name="var36_ROWID">
			<xsl:if test="$var48_current/@ROW_ID">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var37_resultof_exists" select="boolean(string($var36_ROWID))"/>
		<xsl:variable name="var38_OCCSCHEME">
			<xsl:if test="$var48_current/@OCCSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var39_resultof_exists" select="boolean(string($var38_OCCSCHEME))"/>
		<xsl:variable name="var40_ROOFSYS">
			<xsl:if test="$var48_current/@ROOFSYS">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var41_resultof_exists" select="boolean(string($var40_ROOFSYS))"/>
		<xsl:variable name="var42_ROOFGEOM">
			<xsl:if test="$var48_current/@ROOFGEOM">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var43_resultof_exists" select="boolean(string($var42_ROOFGEOM))"/>
		<xsl:variable name="var44_CLADRATE">
			<xsl:if test="$var48_current/@CLADRATE">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var45_resultof_exists" select="boolean(string($var44_CLADRATE))"/>
		<rec>
			...
			<xsl:variable name="var18_resultof_cast" select="string($var48_current/@YEARBUILT)"/>
			<xsl:variable name="var19_resultof_cast" select="string($var48_current/@YEARUPGRAD)"/>
			...
			<xsl:variable name="var14_resultof_contains" select="contains($var17_resultof_substring, $var20_resultof_cast)"/>
			<xsl:variable name="var15_resultof_contains" select="contains($var16_resultof_substring, $var20_resultof_cast)"/>
			...
			<xsl:variable name="var25_resultof_boolean" select="boolean($var24_resultof_vmf__inputtoresult)"/>
			...
			<xsl:if test="string($var45_resultof_exists) != 'false'">
				<xsl:if test="string(($var25_resultof_boolean or boolean(string($var23_ROOFFRAME)))) != 'false'">
					<xsl:attribute name="IrRoofDeck">
						<xsl:choose>
							<xsl:when test="string($var25_resultof_boolean) != 'false'">
			...
			<xsl:if test="string($var41_resultof_exists) != 'false'">
				<xsl:if test="string(($var32_resultof_equal or $var43_resultof_exists)) != 'false'">
