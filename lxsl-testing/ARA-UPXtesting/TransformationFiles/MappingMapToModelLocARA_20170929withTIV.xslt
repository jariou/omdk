...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:agt="http://www.altova.com/Mapforce/agt" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="vmf agt xs">
	...
	<xsl:template name="agt:MapToModelLocARA_withTIV_var58_function">
		<xsl:param name="var57_current"/>
		<xsl:variable name="var55_resultof_cast" select="string('1')"/>
		<xsl:variable name="var56_resultof_cast" select="string('0')"/>
		<xsl:variable name="var43_OCCSCHEME">
			<xsl:if test="$var57_current/@OCCSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var44_resultof_exists" select="boolean(string($var43_OCCSCHEME))"/>
		<xsl:variable name="var45_ROOFGEOM">
			<xsl:if test="$var57_current/@ROOFGEOM">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var46_resultof_exists" select="boolean(string($var45_ROOFGEOM))"/>
		<xsl:variable name="var47_BLDGSCHEME">
			<xsl:if test="$var57_current/@BLDGSCHEME">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var48_resultof_exists" select="boolean(string($var47_BLDGSCHEME))"/>
		<xsl:variable name="var49_CLADRATE">
			<xsl:if test="$var57_current/@CLADRATE">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var50_resultof_exists" select="boolean(string($var49_CLADRATE))"/>
		<xsl:variable name="var51_ROWID">
			<xsl:if test="$var57_current/@ROW_ID">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var52_resultof_exists" select="boolean(string($var51_ROWID))"/>
		<xsl:variable name="var53_ROOFSYS">
			<xsl:if test="$var57_current/@ROOFSYS">
				<xsl:value-of select="'1'"/>
			</xsl:if>
		</xsl:variable>
		<xsl:variable name="var54_resultof_exists" select="boolean(string($var53_ROOFSYS))"/>
		<rec>
			<xsl:attribute name="RecTypeCode60">
				<xsl:value-of select="string('60')"/>
			</xsl:attribute>
			<xsl:attribute name="PolID60">
				<xsl:value-of select="$var55_resultof_cast"/>
			</xsl:attribute>
			...
			<xsl:attribute name="ExchRate60">
				<xsl:value-of select="$var56_resultof_cast"/>
			</xsl:attribute>
			...
			<xsl:if test="string($var52_resultof_exists) != 'false'">
				<xsl:attribute name="LocID63">
					<xsl:value-of select="string($var57_current/@ROW_ID)"/>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var1_STATECODE">
				<xsl:if test="$var57_current/@STATECODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
					...
					<xsl:with-param name="input">
						<xsl:choose>
							<xsl:when test="string(boolean(string($var1_STATECODE))) != 'false'">
								<xsl:value-of select="string($var57_current/@STATECODE)"/>
							</xsl:when>
							<xsl:otherwise>
			...
			<xsl:variable name="var2_COUNTYCODE">
				<xsl:if test="$var57_current/@COUNTYCODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="SubArea">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var2_COUNTYCODE))) != 'false'">
						<xsl:value-of select="string($var57_current/@COUNTYCODE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var3_POSTALCODE">
				<xsl:if test="$var57_current/@POSTALCODE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="PostalArea">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var3_POSTALCODE))) != 'false'">
						<xsl:value-of select="string($var57_current/@POSTALCODE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="'X'"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var4_LATITUDE">
				<xsl:if test="$var57_current/@LATITUDE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="GeoLat">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var4_LATITUDE))) != 'false'">
						<xsl:value-of select="string($var57_current/@LATITUDE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var5_LONGITUDE">
				<xsl:if test="$var57_current/@LONGITUDE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="GeoLong">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var5_LONGITUDE))) != 'false'">
						<xsl:value-of select="string($var57_current/@LONGITUDE)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var6_NUMBLDGS">
				<xsl:if test="$var57_current/@NUMBLDGS">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var6_NUMBLDGS))) != 'false'">
				<xsl:attribute name="RiskCount">
					<xsl:value-of select="string($var57_current/@NUMBLDGS)"/>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var7_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV1VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var8_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV4VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var7_WSCVVAL))) != 'false'">
				<xsl:if test="string(boolean(string($var8_WSCVVAL))) != 'false'">
					<xsl:attribute name="RepValBldg">
						<xsl:value-of select="string((number(string($var57_current/@WSCV1VAL)) + number(string($var57_current/@WSCV4VAL))))"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var9_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV5VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var10_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV8VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var11_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV9VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var12_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV10VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var9_WSCVVAL))) != 'false'">
				<xsl:if test="string(boolean(string($var10_WSCVVAL))) != 'false'">
					<xsl:if test="string(boolean(string($var11_WSCVVAL))) != 'false'">
						<xsl:if test="string(boolean(string($var12_WSCVVAL))) != 'false'">
							<xsl:attribute name="RepValOStr">
								<xsl:value-of select="string((((number(string($var57_current/@WSCV5VAL)) + number(string($var57_current/@WSCV8VAL))) + number(string($var57_current/@WSCV9VAL))) + number(string($var57_current/@WSCV10VAL))))"/>
							</xsl:attribute>
						</xsl:if>
					</xsl:if>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var13_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV2VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var14_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV6VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var13_WSCVVAL))) != 'false'">
				<xsl:if test="string(boolean(string($var14_WSCVVAL))) != 'false'">
					<xsl:attribute name="RepValCont">
						<xsl:value-of select="string((number(string($var57_current/@WSCV2VAL)) + number(string($var57_current/@WSCV6VAL))))"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var15_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV3VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var16_WSCVVAL">
				<xsl:if test="$var57_current/@WSCV7VAL">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var15_WSCVVAL))) != 'false'">
				<xsl:if test="string(boolean(string($var16_WSCVVAL))) != 'false'">
					<xsl:attribute name="RepValTime">
						<xsl:value-of select="string((number(string($var57_current/@WSCV3VAL)) + number(string($var57_current/@WSCV7VAL))))"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			...
			<xsl:variable name="var17_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf2_inputtoresult">
					<xsl:with-param name="input" select="string($var57_current/@BLDGSCHEME)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string($var48_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var17_resultof_vmf__inputtoresult))) != 'false'">
					<xsl:attribute name="ConType">
						<xsl:value-of select="substring($var17_resultof_vmf__inputtoresult, 2)"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var18_BLDGCLASS">
				<xsl:if test="$var57_current/@BLDGCLASS">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string($var48_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var18_BLDGCLASS))) != 'false'">
					<xsl:attribute name="ConBldg">
						<xsl:call-template name="vmf:vmf3_inputtoresult">
							<xsl:with-param name="input" select="concat(string($var57_current/@BLDGSCHEME), string($var57_current/@BLDGCLASS))"/>
						</xsl:call-template>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			...
			<xsl:if test="string($var48_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var19_BLDGCLASS))) != 'false'">
			...
			<xsl:variable name="var20_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf4_inputtoresult">
					<xsl:with-param name="input" select="string($var57_current/@OCCSCHEME)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:if test="string($var44_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var20_resultof_vmf__inputtoresult))) != 'false'">
					<xsl:attribute name="OccType">
						<xsl:value-of select="substring($var20_resultof_vmf__inputtoresult, 2)"/>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var21_OCCTYPE">
				<xsl:if test="$var57_current/@OCCTYPE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string($var44_resultof_exists) != 'false'">
				<xsl:if test="string(boolean(string($var21_OCCTYPE))) != 'false'">
					<xsl:attribute name="Occ">
						<xsl:call-template name="vmf:vmf5_inputtoresult">
							<xsl:with-param name="input" select="concat(string($var57_current/@OCCSCHEME), string($var57_current/@OCCTYPE))"/>
						</xsl:call-template>
					</xsl:attribute>
				</xsl:if>
			</xsl:if>
			<xsl:variable name="var22_YEARUPGRAD">
				<xsl:if test="$var57_current/@YEARUPGRAD">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var23_YEARBUILT">
				<xsl:if test="$var57_current/@YEARBUILT">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:variable name="var30_resultof_cast" select="string('9999')"/>
			<xsl:variable name="var28_resultof_substring" select="substring(string($var57_current/@YEARBUILT), '7', '4')"/>
			<xsl:variable name="var29_resultof_substring" select="substring(string($var57_current/@YEARUPGRAD), '7', '4')"/>
			<xsl:variable name="var26_resultof_contains" select="contains($var28_resultof_substring, $var30_resultof_cast)"/>
			<xsl:variable name="var27_resultof_contains" select="contains($var29_resultof_substring, $var30_resultof_cast)"/>
			<xsl:variable name="var24_result">
				<xsl:choose>
					<xsl:when test="string($var27_resultof_contains) != 'false'">
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var29_resultof_substring"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:variable name="var25_result">
				<xsl:choose>
					<xsl:when test="string($var26_resultof_contains) != 'false'">
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var28_resultof_substring"/>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var22_YEARUPGRAD))) != 'false'">
				<xsl:if test="string(boolean(string($var23_YEARBUILT))) != 'false'">
					<xsl:attribute name="YearBuilt">
						<xsl:choose>
							<xsl:when test="string(($var24_result &gt;= $var25_result)) != 'false'">
								<xsl:choose>
									<xsl:when test="string($var27_resultof_contains) != 'false'">
										<xsl:value-of select="$var56_resultof_cast"/>
									</xsl:when>
			...
			<xsl:variable name="var31_NUMSTORIES">
				<xsl:if test="$var57_current/@NUMSTORIES">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:attribute name="Stories">
				<xsl:choose>
					<xsl:when test="string(boolean(string($var31_NUMSTORIES))) != 'false'">
						<xsl:value-of select="string($var57_current/@NUMSTORIES)"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$var56_resultof_cast"/>
					</xsl:otherwise>
			...
			<xsl:variable name="var32_FLOORAREA">
				<xsl:if test="$var57_current/@FLOORAREA">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var32_FLOORAREA))) != 'false'">
				<xsl:attribute name="GrossArea">
					<xsl:value-of select="string($var57_current/@FLOORAREA)"/>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:if test="string($var46_resultof_exists) != 'false'">
				<xsl:attribute name="IrRoofGeometry">
					<xsl:call-template name="vmf:vmf6_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@ROOFGEOM)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:if test="string($var46_resultof_exists) != 'false'">
			...
			<xsl:if test="string($var54_resultof_exists) != 'false'">
				<xsl:attribute name="IrRoofCover">
					<xsl:call-template name="vmf:vmf8_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@ROOFSYS)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var35_resultof_cast" select="string($var57_current/@CLADRATE)"/>
			<xsl:variable name="var34_resultof_vmf__inputtoresult">
				<xsl:call-template name="vmf:vmf9_inputtoresult">
					<xsl:with-param name="input" select="$var35_resultof_cast"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:variable name="var33_ROOFFRAME">
				<xsl:if test="$var57_current/@ROOFFRAME">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string($var50_resultof_exists) != 'false'">
				<xsl:if test="string(($var34_resultof_vmf__inputtoresult or boolean(string($var33_ROOFFRAME)))) != 'false'">
					<xsl:attribute name="IrRoofDeck">
						<xsl:choose>
							<xsl:when test="string($var34_resultof_vmf__inputtoresult) != 'false'">
							...
							<xsl:otherwise>
								<xsl:call-template name="vmf:vmf11_inputtoresult">
									<xsl:with-param name="input" select="string($var57_current/@ROOFFRAME)"/>
								</xsl:call-template>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:attribute>
			...
			<xsl:if test="string($var50_resultof_exists) != 'false'">
				<xsl:attribute name="IrRoofDeckAttch">
					<xsl:call-template name="vmf:vmf12_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@CLADRATE)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var36_ROOFANCH">
				<xsl:if test="$var57_current/@ROOFANCH">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var36_ROOFANCH))) != 'false'">
				<xsl:attribute name="IrRoofAnchorage">
					<xsl:call-template name="vmf:vmf13_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@ROOFANCH)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			<xsl:variable name="var37_ROOFAGE">
				<xsl:if test="$var57_current/@ROOFAGE">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var37_ROOFAGE))) != 'false'">
				<xsl:attribute name="IrRoofBuilt">
					<xsl:call-template name="vmf:vmf14_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@ROOFAGE)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var38_RESISTOPEN">
				<xsl:if test="$var57_current/@RESISTOPEN">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var38_RESISTOPEN))) != 'false'">
				<xsl:attribute name="IrWindowProt">
					<xsl:call-template name="vmf:vmf15_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@RESISTOPEN)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var39_FOUNDSYS">
				<xsl:if test="$var57_current/@FOUNDSYS">
					<xsl:value-of select="'1'"/>
				</xsl:if>
			</xsl:variable>
			<xsl:if test="string(boolean(string($var39_FOUNDSYS))) != 'false'">
				<xsl:attribute name="IrBldFndConn">
					<xsl:call-template name="vmf:vmf16_inputtoresult">
						<xsl:with-param name="input" select="string($var57_current/@FOUNDSYS)"/>
					</xsl:call-template>
				</xsl:attribute>
			</xsl:if>
			...
			<xsl:variable name="var42_resultof_cast" select="string('12')"/>
			<xsl:variable name="var40_resultof_vmf___inputtoresult">
				<xsl:call-template name="vmf:vmf17_inputtoresult">
					<xsl:with-param name="input" select="string($var57_current/@ROOFSYS)"/>
				</xsl:call-template>
			</xsl:variable>
			<xsl:variable name="var41_resultof_equal" select="($var40_resultof_vmf___inputtoresult = $var42_resultof_cast)"/>
			<xsl:if test="string($var54_resultof_exists) != 'false'">
				<xsl:if test="string(($var41_resultof_equal or $var46_resultof_exists)) != 'false'">
					<xsl:attribute name="IrMechSystem">
						<xsl:choose>
							<xsl:when test="string($var41_resultof_equal) != 'false'">
								<xsl:value-of select="$var42_resultof_cast"/>
							</xsl:when>
							<xsl:otherwise>
	...
	<xsl:template name="agt:MapToModelLocARA_withTIV_var60_resultof_map">
		<xsl:param name="var59_current"/>
		<xsl:for-each select="$var59_current/rec">
			<xsl:call-template name="agt:MapToModelLocARA_withTIV_var58_function">
	...
	<xsl:template match="/">
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">C:/Users/Administrator/Desktop/git/ARA_Ben/flamingo/hurloss/Files/ValidationFiles/ModelLocARA_withTIV.xsd</xsl:attribute>
			<xsl:for-each select="root">
				<xsl:call-template name="agt:MapToModelLocARA_withTIV_var60_resultof_map">
